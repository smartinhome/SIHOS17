...
"<div id='badge' class='badge'>Ladowanie...</div>"
"<div class='section'>"
...
"<button class='btn btn-primary' onclick='saveWifi()'>Polacz z siecia</button>"
...
"if(d.wifi_state==='connected'){b.textContent='WiFi: '+d.ip;"
"b.style.background='#16301f';b.style.color='#22c55e';}"
"else if(d.wifi_state==='ap_mode'){b.textContent='Tryb AP';"
...
"if(!ssid){msg.className='status err';msg.textContent='Podaj nazwe sieci!';return;}"
"msg.className='status ok';msg.textContent='Wysylanie...';"
"try{await fetch('/api/config/wifi',{method:'POST',"
"headers:{'Content-Type':'application/json'},"
"body:JSON.stringify({ssid:ssid,password:pass})});}"
"catch(e){}"
"msg.textContent='Wyslano — urzadzenie restartuje sie i laczy z '+ssid;}"
